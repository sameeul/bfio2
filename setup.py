...
setup(
    ...
    author_email="sameeul.samee@labshare.org",
    url="https://github.com/PolusAI/bfio2",
    description="Image IO library for various formats",
    long_description=long_description,
    long_description_content_type="text/markdown",
    packages=find_packages("src/bfio2/python/"),
    package_dir={"": "src/bfio2/python"},
